      ...
      >
        <div class="td-cta-icon">
          ...
          >
            <g>
              <path
                d="m338.95 243.28-120-75c-
                4.625-2.89-10.453-3.043-15.222-.4-4.77 2.643-7.729 7.667-7.729 13.12v150c0 5.453 2.959 10.476 7.729 13.12 2.266 1.256 4.77 1.88 7.271 1.88 2.763 0 5.522-.763 7.95-2.28l120-75c4.386-2.741 7.05-7.548 7.05-12.72s-2.663-9.979-7.049-12.72zm-112.95 60.656v-95.873l76.698 47.937z"
                fill="#ffffff"
              />
              <path
        ...
        <div class="td-cta-icon">
          ...
          >
            <g>
              ...
              />
              <path
                d="m32.067 482.011h447.85v29.989h-447.85z"
                fill="#ffffff"
              />
              <path
    ...
    C426.667,348.313,412.313,362.667,394.667,362.667z"
      ...
      >
        <div class="td-cta-icon">
          ...
          >
            <path
              d="m213.332031 512c-44.09375 0-80-35.882812-80-80 0-8.832031 7.167969-16 16-16s16 7.167969 16 16c0 26.476562 21.546875 48 48 48s48-21.523438 48-48c0-8.832031 7.167969-16 16-16s16 7.167969 16 16c0 44.117188-35.902343 80-80 80zm0 0"
            />
            <path

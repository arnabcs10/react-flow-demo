...
import TextResponse from "../bot-builder/Responses/TextResponse";
...
import UserSays from "../bot-builder/UserSays";
// import CardRespone from "./Responses/CardResponse";
// import "./main.css";
// import "./style_node.css";

function SideBarNodeDetails({ closeModal, clickedFaq, submitHandler }) {
  const [title, setPayLoad] = useState(clickedFaq.title);
